...
paru -S   google-chrome nvm deno zola bun-bin heroku-cli-bin pnpm obsidian freedownloadmanager signal-desktop onedrive-abraunegg spotify  visual-studio-code-bin  github-cli postman-bin  media-downloader mongodb-bin mongodb-compass wps-office wps-office-mime wps-office-fonts ttf-wps-fonts